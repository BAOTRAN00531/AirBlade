                ...
                switch ($act) {
                    ...
                    case 'addsp':
                        if (isset($_POST['addsp']) && ($_POST['addsp'])) {
                            ...
                            // Đảm bảo rằng mảng $_FILES đã được gửi đi và tồn tại
                            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES['hinh']) && is_array($_FILES['hinh'])) {
                                ...
                                if ($_FILES['hinh']['error'] === UPLOAD_ERR_OK) {
                                    ...
                                    if (isset($_FILES['hinh']['name'])) {
                                        ...
                                        if (!empty($filename)) {
                                            ...
                                            if (file_exists($target_file)) {
                                                ...
                                                if (move_uploaded_file($_FILES["hinh"]["tmp_name"], $target_file)) {
                                                    ...
                                                    echo "Đã xảy ra lỗi khi di chuyển tập tin.";
                                                }
                                            }
                                        } else {
                                        ...
                                        echo "Không tìm thấy phần tử 'hinh' trong mảng.";
                                    }
                                } else {
                                    // Xử lý khi có lỗi xảy ra trong quá trình tải lên
                                    echo "Có lỗi xảy ra khi tải tập tin lên server.";
                                }
                            } else {
                                // Xử lý khi không có tệp nào được tải lên hoặc không phải là một mảng
                                echo "Không có tệp nào được tải lên hoặc không phải là một mảng.";
                            }
